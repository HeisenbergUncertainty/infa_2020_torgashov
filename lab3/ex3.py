...
def tree(x, y, kx, ky): 
     '''
      Функция рисует дерево на экране.
      x, y - координаты левого верхнего угла изображения
      kx, ky - параметры размера (ширина и высота) изобажения
     '''
    rect(screen, (230, 190, 0), (x, y, 10*kx, 10*ky))

def mushroom(x, y, k): 
    '''
      Функция рисует гриб на экране.
      x, y - координаты левого верхнего угла изображения
      k - параметр размера изобажения
     '''
